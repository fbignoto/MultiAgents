...
try:
    ...
    file_path = current_dir / 'data' / 'liquidated.csv'  # Arquivo está na pasta 'data'
    ...
    print(f'Foram inseridos {len(result.inserted_ids)} documentos no MongoDB no banco investment_funds, coleção liquidated')
